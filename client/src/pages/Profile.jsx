    ...
    <div className='min-h-screen bg-cover bg-no-repeat flex items-center justify-center'>
      ...
      <form onSubmit={handleSubmit} className='flex flex-col gap-5 p-10 flex-1'>
        <h3 className='text-lg'>Profile Details</h3>
         ...
         type="text" placeholder='Your Name...' className='p-2 border border-gray-200 rounded-md focus:outline-none 
         focus-ring-2 focus:ring-violet-500' required />
         <textarea onChange={(e) => setBio(e.target.value)} value={bio} placeholder='write a profile..' className='p-2 border border-gray-200 rounded-md focus:outline-none 
         focus-ring-2 focus:ring-violet-500' rows={4} required></textarea>
