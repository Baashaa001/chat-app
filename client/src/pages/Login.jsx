...
function Login() {
  ...
  return (
    ...
    gap-8 sm:justify-evenly max-sm:flex-col backdrop-blur-2xl'>
      ...
      <form onSubmit={SubmitHandler} className="border-2 bg-white/8 text-white border-gray-500 p-6 flex flex-col gap-6 
      rounded-lg shadow-lg">
        <h2 className='font-medium text-2xl flex justify-between items-center'>
          {currState}
          {IsDataSumbitted && <img onClick={() => setIsDataSumbitted(false)} src={assets.arrow_icon} alt="" className='w-5 cursor-pointer' />}
        ...
        { currState === "sign Up" && IsDataSumbitted && (
          ...
          focus:outline-none focus:ring-2 focus:ring-indigo-500' placeholder='comment a bio...' required>
        ...
        <div className='flex flex-col gap-2'>
          {currState === "sign Up" ? (
            ...
            onClick={() => {setcurrState("login"); setIsDataSumbitted(false)}}
